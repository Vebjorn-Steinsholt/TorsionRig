...
<Project Type="Project" LVVersion="24008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Type Definitions" Type="Folder">
			<Property Name="NI.SortType" Type="Int">3</Property>
			<Item Name="MotorBoolControls.ctl" Type="VI" URL="../support/MotorBoolControls.ctl"/>
			<Item Name="ReadSpeed.ctl" Type="VI" URL="../support/ReadSpeed.ctl"/>
			<Item Name="MotorSpeedControls.ctl" Type="VI" URL="../support/MotorSpeedControls.ctl"/>
			<Item Name="UI Data.ctl" Type="VI" URL="../controls/UI Data.ctl"/>
		</Item>
		<Item Name="ErorLogger.vi" Type="VI" URL="../ErorLogger.vi"/>
		<Item Name="logging.vi" Type="VI" URL="../controls/logging.vi"/>
		<Item Name="LoggingSystem.vi" Type="VI" URL="../LoggingSystem.vi"/>
		<Item Name="Main.vi" Type="VI" URL="../Main.vi"/>
		<Item Name="ModbusMotorDriver.vi" Type="VI" URL="../ModbusMotorDriver.vi"/>
		<Item Name="ModbusRead.vi" Type="VI" URL="../ModbusRead.vi"/>
		<Item Name="ModbusWrite.vi" Type="VI" URL="../ModbusWrite.vi"/>
		<Item Name="Motor Controller.vi" Type="VI" URL="../controls/Motor Controller.vi"/>
		<Item Name="MotorBoolControlsIndicators.ctl" Type="VI" URL="../support/MotorBoolControlsIndicators.ctl"/>
		<Item Name="MotorStatusIndicators.ctl" Type="VI" URL="../support/MotorStatusIndicators.ctl"/>
		<Item Name="RegisterSplit.vi" Type="VI" URL="../RegisterSplit.vi"/>
		<Item Name="RemoveInvalidValues.vi" Type="VI" URL="../RemoveInvalidValues.vi"/>
		<Item Name="SplitDouble.vi" Type="VI" URL="../SplitDouble.vi"/>
		<Item Name="ZeroLoggingSystem.vi" Type="VI" URL="../ZeroLoggingSystem.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="user.lib" Type="Folder">
				<Item Name="AssignSignals.vi" Type="VI" URL="/&lt;userlib&gt;/HBM LabVIEW Driver/VIs/System/AssignSignals.vi"/>
				<Item Name="ConfigSignal.vi" Type="VI" URL="/&lt;userlib&gt;/HBM LabVIEW Driver/VIs/System/ConfigSignal.vi"/>
				<Item Name="ConnectDevice.vi" Type="VI" URL="/&lt;userlib&gt;/HBM LabVIEW Driver/VIs/System/ConnectDevice.vi"/>
				<Item Name="DisconnectDevice.vi" Type="VI" URL="/&lt;userlib&gt;/HBM LabVIEW Driver/VIs/System/DisconnectDevice.vi"/>
				<Item Name="DisposeApi.vi" Type="VI" URL="/&lt;userlib&gt;/HBM LabVIEW Driver/VIs/System/DisposeApi.vi"/>
				<Item Name="ExecuteZeroing.vi" Type="VI" URL="/&lt;userlib&gt;/HBM LabVIEW Driver/VIs/System/ExecuteZeroing.vi"/>
				<Item Name="GetDeviceFromSignal.vi" Type="VI" URL="/&lt;userlib&gt;/HBM LabVIEW Driver/VIs/System/GetDeviceFromSignal.vi"/>
				<Item Name="GetMeasurementValues.vi" Type="VI" URL="/&lt;userlib&gt;/HBM LabVIEW Driver/VIs/DAQ/GetMeasurementValues.vi"/>
				<Item Name="GetSignals.vi" Type="VI" URL="/&lt;userlib&gt;/HBM LabVIEW Driver/VIs/System/GetSignals.vi"/>
				<Item Name="Hbm.Api.Common.dll" Type="Document" URL="/&lt;userlib&gt;/HBM LabVIEW Driver/DLLs/Hbm.Api.Common.dll"/>
				<Item Name="Hbm.Api.LabVIEW.dll" Type="Document" URL="/&lt;userlib&gt;/HBM LabVIEW Driver/DLLs/Hbm.Api.LabVIEW.dll"/>
				<Item Name="Hbm.Api.QuantumX.dll" Type="Document" URL="/&lt;userlib&gt;/HBM LabVIEW Driver/DLLs/Hbm.Api.QuantumX.dll"/>
				<Item Name="Hbm.LicenseManager.dll" Type="Document" URL="/&lt;userlib&gt;/HBM LabVIEW Driver/DLLs/Hbm.LicenseManager.dll"/>
				<Item Name="Init.vi" Type="VI" URL="/&lt;userlib&gt;/HBM LabVIEW Driver/VIs/System/Init.vi"/>
				<Item Name="PrepareDAQ.vi" Type="VI" URL="/&lt;userlib&gt;/HBM LabVIEW Driver/VIs/DAQ/PrepareDAQ.vi"/>
				<Item Name="Problems.vi" Type="VI" URL="/&lt;userlib&gt;/HBM LabVIEW Driver/VIs/System/Problems.vi"/>
				<Item Name="QuantumX_Device.vi" Type="VI" URL="/&lt;userlib&gt;/HBM LabVIEW Driver/VIs/QuantumX/QuantumX_Device.vi"/>
				<Item Name="StartDaq.vi" Type="VI" URL="/&lt;userlib&gt;/HBM LabVIEW Driver/VIs/DAQ/StartDaq.vi"/>
				<Item Name="StopDaq.vi" Type="VI" URL="/&lt;userlib&gt;/HBM LabVIEW Driver/VIs/DAQ/StopDaq.vi"/>
				<Item Name="UpdateMeasurementValues.vi" Type="VI" URL="/&lt;userlib&gt;/HBM LabVIEW Driver/VIs/DAQ/UpdateMeasurementValues.vi"/>
			</Item>
